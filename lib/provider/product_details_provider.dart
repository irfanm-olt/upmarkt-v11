...
class ProductDetailsProvider extends ChangeNotifier {
  ...
  void initData(Product product, BuildContext context) {
    _variantIndex = 0;
  ...
  void setCartVariantIndex(Product product,int index, BuildContext context) {
    _variantIndex = index;
    _quantity = product.minimumOrderQuantity;
    notifyListeners();
  }

  void setCartVariationIndex(Product product, int index, int i, BuildContext context) {
